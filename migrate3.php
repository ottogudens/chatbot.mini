...
// === Parte 1: AI configuration columns for assistants (gemini-2.5-flash-lite) ===
...
$update_sql = "UPDATE assistants SET gemini_model='gemini-2.5-flash-lite' WHERE gemini_model='gemini-2.0-flash-lite'";
if (mysqli_query($conn, $update_sql)) {
    $affected = mysqli_affected_rows($conn);
    echo "OK: $affected asistentes actualizados a gemini-2.5-flash-lite.\n";
} else {
...
$alter_default = "ALTER TABLE assistants MODIFY COLUMN gemini_model VARCHAR(50) NOT NULL DEFAULT 'gemini-2.5-flash-lite'";
if (mysqli_query($conn, $alter_default)) {
    echo "OK: DEFAULT de gemini_model actualizado a gemini-2.5-flash-lite.\n";
} else {
    echo "Error: " . mysqli_error($conn) . "\n";
}
